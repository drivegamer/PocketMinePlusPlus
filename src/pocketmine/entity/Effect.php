...
class Effect{
	...
	public static function init(){
		...
		self::$effects[Effect::HARMING] = new InstantEffect(Effect::HARMING, "%potion.harm", 67, 10, 9, \true);
		...
		self::$effects[Effect::HUNGER] = new Effect(Effect::HUNGER, "%potion.hunger", 79, 145, 49, \true);

...
class Utils{
	...
	public static function randomUUID(){
		return Utils::toUUID(\pack("N", \time()) . \pack("n", \getmypid()) . \pack("n", \getmyuid()) . \pack("N", \mt_rand(-0x7fffffff, 0x7fffffff)) . \pack("N", \mt_rand(-0x7fffffff, 0x7fffffff)), 2);
	}
	...
	public static function dataToUUID(...$params){
		return Utils::toUUID(\hash("md5", \implode($params), \true), 3);
	}

...
class Item{
	...
	private static function initCreativeItems(){
		...
		self::addCreativeItem(Item::get(Item::QUARTZ_ORE, 0));
		...
		self::addCreativeItem(Item::get(Item::IRON_PRESSURE_PLATE, 0));
		self::addCreativeItem(Item::get(Item::WOOD_BUTTON, 0));
